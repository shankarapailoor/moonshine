...
//line trace2syz/straceLex.rl:18
...
//line trace2syz/straceLex.rl:34
    return lex
}
...
{out.data = string(lex.data[lex.ts:lex.te]); tok = DATETIME; {( lex.p)++;  lex.cs = 174; goto _out }}
	goto st174
tr235:
//line trace2syz/straceLex.rl:73
 lex.te = ( lex.p)
( lex.p)--
...
{tok = RESUMED; {( lex.p)++;  lex.cs = 174; goto _out }}
	goto st174
tr241:
//line trace2syz/straceLex.rl:86
 lex.te = ( lex.p)
( lex.p)--
{tok = EQUALS;{( lex.p)++;  lex.cs = 174; goto _out }}
	goto st174
tr242:
//line trace2syz/straceLex.rl:87
 lex.te = ( lex.p)+1
{tok = LEQUAL; {( lex.p)++;  lex.cs = 174; goto _out }}
	goto st174
tr243:
//line trace2syz/straceLex.rl:104
 lex.te = ( lex.p)+1
{tok = ARROW; {( lex.p)++;  lex.cs = 174; goto _out }}
	goto st174
tr244:
//line trace2syz/straceLex.rl:80
 lex.te = ( lex.p)
( lex.p)--
{out.data = string(lex.data[lex.ts:lex.te]); tok = IDENTIFIER;{( lex.p)++;  lex.cs = 174; goto _out }}
	goto st174
tr249:
//line trace2syz/straceLex.rl:78
 lex.te = ( lex.p)
( lex.p)--
{out.data = string(lex.data[lex.ts:lex.te]); tok = FLAG; {( lex.p)++;  lex.cs = 174; goto _out }}
	goto st174
tr263:
//line trace2syz/straceLex.rl:96
 lex.te = ( lex.p)
( lex.p)--
{tok = OR;{( lex.p)++;  lex.cs = 174; goto _out }}
	goto st174
tr264:
//line trace2syz/straceLex.rl:105
 lex.te = ( lex.p)+1
...
//line trace2syz/straceLex.rl:77
 lex.act = 10;
	goto st177
	st177:
		if ( lex.p)++; ( lex.p) == ( lex.pe) {
...
//line trace2syz/straceLex.rl:85
 lex.act = 18;
	goto st199
tr259:
//line NONE:1
...
//line trace2syz/straceLex.rl:83
 lex.act = 16;
	goto st199
	st199:
		if ( lex.p)++; ( lex.p) == ( lex.pe) {
...
//line trace2syz/lex.go:4926
	...
	st_case_217:
		...
		goto tr263
tr265:
//line trace2syz/straceLex.rl:65
 lex.te = ( lex.p)+1
...
( lex.p)--
	...
	goto st218
tr268:
//line trace2syz/straceLex.rl:66
 lex.te = ( lex.p)+1
{{goto st174 }}
	goto st218
	st218:
...
//line trace2syz/straceLex.rl:115
