...
var (
	...
	SocketLevelMap = map[string]string{
	...
	SendmsgLabels = map[string]string{
		"fd":            "",
		"sock":          "",
		"sock_in6":      "",
		"sock_in":       "",
	...
	SocketLabelsPair = map[Pair]string{
